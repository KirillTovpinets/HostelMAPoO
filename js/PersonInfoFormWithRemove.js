var FirstId = document.location.href.split("=")[1];
var IdAndMess = FirstId.split("&");
var PersonId = IdAndMess[0];
var PlaceId = document.location.href.split("=")[2];
document.getElementById("PersonId").setAttribute('value', PersonId);
document.getElementById("removeBtn").setAttribute('href', "php/deletePerson.php?id=" + PlaceId);
